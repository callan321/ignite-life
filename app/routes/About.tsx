  ...
  return (
    <>
      <div className="w-full max-w-[1960px] mx-auto">
        <div className="relative isolate flex items-center justify-center h-[36rem] md:h-[48rem] lg:h-[64rem] overflow-hidden bg-[#5A6F5A]">
          <img
            src="/bowen3.jpg"
            alt="Slogan"
          ...
          <div className="w-96 lg:w-[44rem] text-gray-800 p-8 text-center bg-white rounded border-gray-50 opacity-85 shadow-lg">
            ...
            <p>
              ...
              system function and facilitate correction of the dysfunction to
              restore homeostasis.
            </p>
            <br />
            <h4 className="text-[#7f6000]">BOWEN CAN HELP</h4>
            <p>
              ...
              corrections, it initiates the human body’s innate self-healing
              response. Therefore, Bowen can used to treat and help a wide
              variety of problems from musculoskeletal or related neurological
              problems including acute sports injuries and chronic or organic
              conditions.
            </p>
            <br />
            <h4 className="text-[#7f6000]">For Example:</h4>
            <p>
